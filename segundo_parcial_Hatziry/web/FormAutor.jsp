<%-- 
    Document   : RegistroAutor
    Created on : 11/11/2022, 13:33:00
...
<html>
    <head>
        ...
        <script src="Js/JsAutor.js" type="text/javascript"></script>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="#">Libros registrados</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="shadow-lg p-3 bg-white rounded">
                <form method="POST" id="form" name="form" action="NewServlet">
                    <div class="mt-3 mb-5 mx-4">
                        ...
                        <h2 class="display-4 text-center my-4">  REGISTRO DE AUTOR</h2>
                        <div class="row">
                            <div class="col-md-4">
                                <label for="codigo">Código</label>
                                <input type="int" class="form-control" placeholder="2046822" name="codigo" id-="codigo">
                                <input type="hidden" name="control" value="GUARDAR">
                            </div>
                            <div class="col">
                                <label for="nombre">Nombre y apellido</label>
                                <input type="text" class="form-control" placeholder="Ejem. Gabriel García Marquez" name="nombre" id="nombre">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputState">Género literario</label>
                            <select name="genero" id="genero" class="form-control">
                                <option value="Poesía" selected>Poesía</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="editorial">Lugar de nacimiento</label>
                                <input type="text" class="form-control" placeholder="Ejem. Colombia" name="origen" id="origen">
                            </div>
                            <div class="col">
                                <label for="año">Fecha de nacimiento</label>
                                <input type="text" class="form-control" placeholder=" Ejem. 1927" name="fecha" id="fecha">
                            </div>
                        </div>
